...
export type LinkedAccount = {
  ...
  membershipType: LinkedAccountMembershipType;
...
export enum LinkedAccountMembershipType {
  Barclays = 'BARCLAYS',
  Hsbc = 'HSBC',
  Lloyds = 'LLOYDS',
  None = 'NONE'
...
export type Pricing = {
  __typename?: 'Pricing';
  /** This is the cost to the partner when pricing type is fixed */
  cost: Scalars['Float'];
...
export type LinkAccountMutation = { __typename?: 'Mutation', linkAccount?: { __typename?: 'LinkedAccount', id: string, externalID: string, provider: LinkedAccountProvider, membershipID?: string | null, membershipType: LinkedAccountMembershipType, createdAt: any, updatedAt: any, consumer: { __typename?: 'Consumer', id: string, fullName?: string | null, firstName?: string | null, lastName?: string | null, dateOfBirth?: any | null, emailAddress: string, phone?: string | null, crmId?: string | null, createdAt: any, updatedAt: any, linkedAccounts: Array<{ __typename?: 'LinkedAccount', id: string }> } } | null };
