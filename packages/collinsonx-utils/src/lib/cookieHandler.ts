// Source: https://github.com/supertokens/supertokens-auth-react/blob/master/examples/with-next-iframe/config/cookieHandler.js
...
export default function getCookieHandler(original: any) {
  return {
    ...original,
