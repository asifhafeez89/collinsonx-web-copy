...
import { Table as ReactTable, RowModel, flexRender, useReactTable } from '@tanstack/react-table';
...
jest.mock('@tanstack/react-table', () => {
  return {
    __esModule: true,
    useReactTable: () => ({
      getHeaderGroups: () => { return ([]) },
      getRowModel: () => {
        return ({
          rows: [{
            id: '123', getVisibleCells: () => {
              return ([{
                id: '23',
                column: {
                  columnDef: {
...
describe('<type />', () => {
  it('should render', () => {
      ...
      data: [
        {
          ...
          "consumer": {
            "__typename": "Consumer",
            "emailAddress": "automationconsumertest@collinsonxteam.testinator.com",
    ...
    const component = render(
      <Table table={table} type={'pending'} />
    );
