  ...
  lounge: {
    ...
    errors: {
      ...
      terminalsMismatch: {
        ...
        description:
          'Please note, that the lounge you are booking is not in the terminal your flight is scheduled. Lounge terminal is at North Terminal. Flight departure terminal is from South TerminalDo you still want to book this lounge even it is not in the terminal of dep',
        btn: {
          return: 'Return to lounges',
  ...
  booking: {
    ...
    availableSlots: {
      ...
      hsbcCancelationPolicy: {
        ...
        descriptionLine2:
          'For HSBC Premier World Elite cardholders, please note whilst you do receive free visit passes for yourself and any additional cardholders (i.e., not your guests) - the pre-booking fee will act as a separate fee, and also apply to you and your guests. When',
      },
      cancellationPolicy: {
