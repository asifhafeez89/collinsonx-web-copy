...
import { AccountProvider, BridgePayload } from 'types/booking';
...
describe('<PinLockout />', () => {
  let mockPayload = {} as BridgePayload;
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  it('renders', () => {
    const { getByRole, getByTestId } = render(
      <PinLockout payload={mockPayload} />
    );
  ...
  describe('push', () => {
    it('redirects to login on button click', () => {
      ...
      const component = render(<PinLockout payload={mockPayload} />);
    ...
    describe('reroutes to correct contact page', () => {
      it.each`
        ...
        ${'HSBC'}   | ${true}        | ${'https://memberhelp.prioritypass.com/en/support/home'}
      ...
      `(
        ...
        ({ accountType, membershipType, url }) => {
          ...
          const defaultPayload = {
            ...
            lounge: '',
            sourceCode: '',
            accountProvider: 'PP' as AccountProvider,
          };

          mockPayload = membershipType
            ? { ...defaultPayload, membershipType: accountType }
            : { ...defaultPayload, accountProvider: accountType };
