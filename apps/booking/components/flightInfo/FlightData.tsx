...
import { Accordion } from '@collinsonx/design-system/core';
      ...
      {flightInfoData && flightInfoData[0] ? (
        <Accordion variant="separated">
          <Accordion.Item value="customization">
            <Accordion.Control>Departing Flight Information</Accordion.Control>
            <Accordion.Panel>
              <p>Departing Airport: {flightInfoData[0].departure?.airport}</p>
              <p>
          ...
          <Accordion.Item value="flexibility">
            <Accordion.Control>Arrival Flight Information</Accordion.Control>
            <Accordion.Panel>
